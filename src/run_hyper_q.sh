...
output_root_folder="output/eqr_hyper_test"
# run k from 3 to 10
for i in 3 4 5 6 7 8 9 10; do
    ...
    for query_processor_mode in "${modes[@]}"; do
        ...
        python -m src.QueryProcessor.queryProcessorRunner --input_path $original_query_input_path --o $output_root_folder --mode $query_processor_mode --k $i
        ...
        # run dense retriever
        python -m src.Retriever.retrieverRunner --q $processed_query_output_path --o $retriever_output_dir --chunks_dir $doc_chunks_dir --embedding_dir $doc_embeddings_dir --emb_type $embedder_type --n "8"
