...
# ranked_list_path="output\hidden_gem\results\rank_list_none.json"
# ground_truth_path="data\ground_truth\ground_truth_test.json"
# retriever_output_dir="output\hidden_gem\results"
