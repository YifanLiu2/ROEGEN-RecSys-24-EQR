...
for domain in "hotel_nyc" "hotel_beijing" "travel_dest" "restaurant_phi" "restaurant_nol"; do
# for domain in "hotel_nyc"; do

    for mode in "eqr_1" "eqr_3" "eqr_5" "eqr_7" "eqr_9" "eqr_11" "eqr_13" "eqr_15" "eqr_17" "eqr_20"; do
